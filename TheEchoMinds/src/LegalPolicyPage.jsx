  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <div className="relative z-10">
        <SiteSubpageHeader
          leading={<h1 className="text-lg md:text-xl font-semibold tracking-wide text-white">Privacy Policy</h1>}
        />
          ...
          <div className="max-w-3xl mx-auto space-y-12">
              ...
              <dl className="grid gap-2 text-sm md:text-base text-gray-300 pt-2 border-t border-white/10">
                ...
                <div>
                  ...
                  <dd>
                    ...
                    <span className="block text-gray-400 text-sm mt-1">CIN: U62090TS2026PTC215177</span>
                  </dd>
                </div>
              </dl>
            </motion.div>
            ...
            <div className="space-y-10">
              <Section title="1. Who we are" delay={0.05}>
                <p>
                  TheEchoMinds Pvt. Ltd. operates the App under the EchoMinds brand, and this website where this policy is
